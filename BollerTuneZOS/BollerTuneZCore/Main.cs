...
namespace BollerTuneZCore
{
	public class Main
	{
	    ...
	    public Main(ISteeringProcessor steeringProcessor, IEngineProcessor engineProcessor, ISerialDeviceHelper serialDeviceHelper, IArgumentTranslator argumentTranslator, IBTZJoyStickController joyStickController, ISettingsRepository settingsRepository)
	    {
